...
| **Document** | [Full Documentation](https://github.com/farisNassif/FourthYear_GestureBasedUIDevelopment/blob/master/Documentation/DocumentReport/Gesture-Based-Document.pdf)
| **Authors** | [Faris Nassif](https://github.com/farisNassif) & [Alex Cherry](https://github.com/moecherry99) |
...
We also enabled an array of hand objects to be recognized along with removing the single entity limit in the BodySourceManager, allowing for more than one player to participate in the game at any given time.
...
<p align="center">
  ...
  <br>
  <i>Simple but effective swipe gesture, easy for the user to perform and since it was solely used to assist with UI traversal both left     and right-handed swipes could be registered.</i>
</p>
...
<p align="center">
  ...
  <br>
  <i>Continious Flying gesture that when performed by the player caused the Bird to ascend.</i>
</p>
...
<p align="center">
  <img src ="Documentation/ReadmeImages/Speech.png" width="200" height="300">
  <br>
  <i>An array of speech commands were implemented allowing for seamless traversal of the application</i>
</p>

<p align="center">
    <b><i>For a more in depth analysis of the project as a whole please see the <a href="https://github.com/farisNassif/FourthYear_GestureBasedUIDevelopment/blob/master/Documentation/DocumentReport/Gesture-Based-Document.pdf">full documentation</a></i></b>
</p>
...
<br>
<i>*References relating to specific classes will be referenced in those classes</i>
